...
public class AddTable : Migration
{
    public override void Up()
    {
        ...
        .WithColumn(nameof(BaseEntity.IsActive)).AsBoolean().WithDefaultValue(true).NotNullable()
        ...
        .WithColumn(nameof(BaseEntity.UpdatedDate)).AsDateTime().Nullable()
        .WithColumn(nameof(BaseEntity.UpdatedIP)).AsString().Nullable()
        .WithColumn(nameof(BaseEntity.UpdatedByUserId)).AsGuid().Nullable()
