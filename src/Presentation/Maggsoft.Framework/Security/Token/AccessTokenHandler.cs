...
public class AccessTokenHandler(IOptions<ApiTokenOptions> tokenOptions, IHttpContextAccessor context) : IAccessTokenHandler
{
    private readonly ApiTokenOptions _tokenOptions = tokenOptions.Value;
