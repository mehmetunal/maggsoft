...
using Maggsoft.Mysql.Repository;
...
namespace Maggsoft.Mysql.Services  
{
        ...
        where TAddDto : BaseDtoModel
    {
        ...
        public readonly IMysqlRepository<TTable> Repository;
        ...
        protected MssqlBaseServices()
        {
            ...
            Repository = MaggsoftContext.Current.Resolve<IMysqlRepository<TTable>>()
                     ?? throw new ArgumentNullException($"{nameof(IMysqlRepository<TTable>)} is null");
        }
