...
/// </summary>
public partial class EmailAccountService(IMysqlRepository<EmailAccount> emailAccountRepository) : IEmailAccountService
{
    #region Fields
    private readonly IMysqlRepository<EmailAccount> _emailAccountRepository = emailAccountRepository;
