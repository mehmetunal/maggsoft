...
namespace Maggsoft.Mongo.Service.Messages;

/// <summary>
/// Email account service
/// </summary>
public partial class EmailAccountService(IMongoRepository<EmailAccount> emailAccountRepository) : IEmailAccountService
{
    #region Fields
    private readonly IMongoRepository<EmailAccount> _emailAccountRepository = emailAccountRepository;
