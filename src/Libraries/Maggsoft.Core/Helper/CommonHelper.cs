...
namespace Maggsoft.Core.Helper;
...
public partial class CommonHelper
{
    ...
    static CommonHelper()
    {
        _emailRegex = new (EMAIL_EXPRESSION, RegexOptions.IgnoreCase);
    }
    ...
    public static string EnsureSubscriberEmailOrThrow(string email)
    {
        ...
        {
            throw new MaggsoftException("Email is not valid.");
        }
    ...
    public static void SetProperty(object instance, string propertyName, object value)
    {
        ...
        if (pi == null)
            throw new MaggsoftException("No property '{0}' found on the instance of type '{1}'.", propertyName, instanceType);
        if (!pi.CanWrite)
            throw new MaggsoftException("The property '{0}' on the instance of type '{1}' does not have a setter.", propertyName, instanceType);
