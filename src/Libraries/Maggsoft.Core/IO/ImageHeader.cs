...
//NOTE : https://khalidabuhakmeh.com/verify-user-file-uploads-with-dotnet
/// https://github.com/dotnet/AspNetCore.Docs/blob/main/aspnetcore/mvc/models/file-uploads.md
/// https://github.com/dotnet/AspNetCore.Docs/issues/18012
...
/// https://github.com/smartstore/SmartStoreNET/blob/a4159db495aaa170ff1e868befffc363a5fb09d1/src/Libraries/SmartStore.Core/IO/ImageHeader.cs#L16
/// <summary>
            ...
            while (reader.Read())
            {
                if (reader.IsStartElement())
                {
                    if (reader.Name == "svg")
                    {
                        ...
                        var size = new Size(int.Parse(width), int.Parse(height));
                        if (size.Width == 0 || size.Height == 0)
                        {
                            ...
                            if (viewBox.HasValue())
                            {
                                ...
                                {
                                    size = new Size(int.Parse(arrViewBox[2]), int.Parse(arrViewBox[3]));
                                }
                            }
                        }
