...
public partial class MigrationManager(
    ...
    Lazy<IVersionLoader> versionLoader) : IMigrationManager
{
    #region Fields
    ...
    private readonly IMigrationRunnerConventions _migrationRunnerConventions = migrationRunnerConventions;
    private readonly Lazy<IVersionLoader> _versionLoader = versionLoader;
